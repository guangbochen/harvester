...
type SourceSpec struct {
	// TypeMeta only exists for API backwards compatibility
	...
	// VirtualMachineStatus is here simply for backwards compatibility with a previous API.
	// +nullable
	// +optional
	Status *kv1.VirtualMachineStatus `json:"status,omitempty"`
}
...
type PersistentVolumeClaimSpec struct {
	...
	// PersistentVolumeClaimStatus is here simply for backwards compatibility with a previous API.
	// +nullable
	// +optional
